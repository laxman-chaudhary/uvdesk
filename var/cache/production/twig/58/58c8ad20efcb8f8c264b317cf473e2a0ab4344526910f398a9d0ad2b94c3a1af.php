...
class __TwigTemplate_3d0ca33300f90f063d01bfba672702391978a22ab9bf347a644acbb471a87aea extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t<img src=\"";
        ...
        echo "<%= smallThumbnail.slice(1) %>\" alt=\"\"/>
\t\t\t<% } else { %>
\t\t\t<img src=\"";
        // line 113
...
\t\t   <% if(role == \"Agent\") { %>
        ...
        // line 121
        echo "         \t   <% } else if(role == \"Account Owner\"){ %>
\t\t\t";
        // line 122
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Account Owner", [], "messages");
        // line 123
        echo "\t\t   <%}else if(role == \"Administrator\"){ %>
\t\t\t";
        // line 124
...
";
    ...
    {
        return array (  508 => 310,  504 => 309,  454 => 264,  450 => 263,  434 => 250,  338 => 157,  324 => 146,  320 => 145,  311 => 139,  306 => 137,  301 => 135,  294 => 131,  289 => 129,  283 => 125,  281 => 124,  278 => 123,  276 => 122,  273 => 121,  271 => 120,  261 => 113,  256 => 111,  251 => 108,  223 => 81,  217 => 78,  210 => 77,  199 => 71,  190 => 64,  186 => 63,  182 => 62,  178 => 61,  174 => 60,  168 => 56,  158 => 51,  152 => 48,  137 => 35,  131 => 31,  122 => 24,  116 => 20,  110 => 16,  104 => 15,  99 => 13,  96 => 12,  93 => 11,  90 => 10,  87 => 8,  80 => 7,  68 => 5,  55 => 3,  38 => 1,);
    }
...
\t\t});
\t</script>
{% endblock %}", "@UVDeskCoreFramework/Agents/listSupportAgents.html.twig", "/home/support.telenet.com.np/public_html/vendor/uvdesk/core-framework/Resources/views/Agents/listSupportAgents.html.twig");
    }
}
