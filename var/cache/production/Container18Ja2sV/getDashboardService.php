 ...
 */
class getDashboardService extends App_KernelProductionDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/uvdesk/extension-framework/Controller/Dashboard.php';
