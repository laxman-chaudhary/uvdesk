 ...
 */
class getKnowledgebaseXHRService extends App_KernelProductionDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Webkul\\UVDesk\\SupportCenterBundle\\Controller\\KnowledgebaseXHR'] = $instance = new \Webkul\UVDesk\SupportCenterBundle\Controller\KnowledgebaseXHR(($container->services['user.service'] ?? $container->load('getUser_ServiceService')), ($container->services['translator'] ?? $container->load('getTranslatorService')));
