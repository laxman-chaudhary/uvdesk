 ...
 */
class getAnnouncementRepositoryService extends App_KernelProductionDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/uvdesk/support-center-bundle/Repository/AnnouncementRepository.php';
