 ...
 */
class getFolderService extends App_KernelProductionDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Webkul\\UVDesk\\SupportCenterBundle\\Controller\\Folder'] = $instance = new \Webkul\UVDesk\SupportCenterBundle\Controller\Folder(($container->services['user.service'] ?? $container->load('getUser_ServiceService')), ($container->services['translator'] ?? $container->load('getTranslatorService')), ($container->services['uvdesk.core.file_system.service'] ?? $container->load('getUvdesk_Core_FileSystem_ServiceService')), ($container->privates['Webkul\\UVDesk\\CoreFrameworkBundle\\Services\\FileUploadService'] ?? $container->load('getFileUploadServiceService')));
