 ...
 */
class getCustomerXHRService extends App_KernelProductionDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Webkul\\UVDesk\\CoreFrameworkBundle\\Controller\\CustomerXHR'] = $instance = new \Webkul\UVDesk\CoreFrameworkBundle\Controller\CustomerXHR(($container->services['user.service'] ?? $container->load('getUser_ServiceService')), ($container->services['event_dispatcher'] ?? $container->getEventDispatcherService()), ($container->services['translator'] ?? $container->load('getTranslatorService')));
