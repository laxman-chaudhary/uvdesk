...
class getCustomer2Service extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Webkul\\UVDesk\\SupportCenterBundle\\Controller\\Customer'] = $instance = new \Webkul\UVDesk\SupportCenterBundle\Controller\Customer(($container->services['translator'] ?? $container->getTranslatorService()), ($container->services['.container.private.security.password_encoder'] ?? $container->load('get_Container_Private_Security_PasswordEncoderService')), ($container->services['uvdesk.core.file_system.service'] ?? $container->getUvdesk_Core_FileSystem_ServiceService()), ($container->privates['Webkul\\UVDesk\\CoreFrameworkBundle\\Services\\FileUploadService'] ?? $container->getFileUploadServiceService()));
