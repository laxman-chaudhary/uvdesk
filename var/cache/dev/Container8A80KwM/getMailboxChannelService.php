 ...
 */
class getMailboxChannelService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Webkul\\UVDesk\\MailboxBundle\\Controller\\MailboxChannel'] = $instance = new \Webkul\UVDesk\MailboxBundle\Controller\MailboxChannel(($container->services['user.service'] ?? $container->getUser_ServiceService()), ($container->privates['Webkul\\UVDesk\\MailboxBundle\\Services\\MailboxService'] ?? $container->load('getMailboxServiceService')), ($container->services['translator'] ?? $container->getTranslatorService()), ($container->services['swiftmailer.service'] ?? ($container->services['swiftmailer.service'] = new \Webkul\UVDesk\CoreFrameworkBundle\SwiftMailer\SwiftMailer($container))));
