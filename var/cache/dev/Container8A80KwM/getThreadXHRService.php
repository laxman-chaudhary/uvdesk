 ...
 */
class getThreadXHRService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/uvdesk/core-framework/Controller/ThreadXHR.php';

        $container->services['Webkul\\UVDesk\\CoreFrameworkBundle\\Controller\\ThreadXHR'] = $instance = new \Webkul\UVDesk\CoreFrameworkBundle\Controller\ThreadXHR(($container->services['ticket.service'] ?? $container->getTicket_ServiceService()));
