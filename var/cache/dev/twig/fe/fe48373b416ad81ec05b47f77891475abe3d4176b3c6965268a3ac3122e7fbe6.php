...
class __TwigTemplate_889ff323b4577695fd2820b8768afabec18d82ca69195ac720c6e693ba1dc864 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t";
        // line 101
        echo twig_escape_filter($this->env, (((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 101, $this->source); })()), "status", [], "any", false, false, false, 101), 1))) ? ($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Published")) : ($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Draft"))), "html", null, true);
        echo "
\t\t\t\t\t\t\t</span>
...
\t\t\t\t\t\t\t\t";
        // line 119
        echo twig_escape_filter($this->env, (((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 119, $this->source); })()), "stared", [], "any", false, false, false, 119), 1))) ? ($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Yes")) : ($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("No"))), "html", null, true);
        echo "
\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t<div class=\"uv-dropdown-list uv-bottom-left\">
\t\t\t\t\t\t\t\t<div class=\"uv-dropdown-container\">
...
\t\t\t\t\t\tmsg: '";
        // line 674
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("This field contain mata title maximum 200 charecters only"), "html", null, true);
        echo "'
\t\t\t\t\t}],
\t\t\t\t\t'keywords':[{
\t\t\t\t\t\tmaxLength:200,
\t\t\t\t\t\tmsg: '";
        // line 678
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("This field contain keywords maximum 200 charecters only"), "html", null, true);
        echo "'
\t\t\t\t\t}],
...
\t\t\tvar articlemodel = new ArticleModel({
                id : \"";
        // line 698
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 698, $this->source); })()), "id", [], "any", false, false, false, 698), "html", null, true);
        echo "\",
                name : \"";
        // line 699
        echo twig_escape_filter($this->env, twig_replace_filter(twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 699, $this->source); })()), "name", [], "any", false, false, false, 699), ["
" => " ", "" => " "]), "html", null, true);
        echo "\",
                slug : \"";
        // line 700
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 700, $this->source); })()), "slug", [], "any", false, false, false, 700), "html", null, true);
        echo "\",
\t\t\t\tstatus: \"";
        // line 701
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 701, $this->source); })()), "status", [], "any", false, false, false, 701), "html", null, true);
        echo "\",
\t\t\t\tstared: \"";
        // line 702
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 702, $this->source); })()), "stared", [], "any", false, false, false, 702), "html", null, true);
        echo "\",
\t\t\t})
...
\t\t\t\t\tvar tinymceContent = `";
        // line 760
        echo twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 760, $this->source); })()), "content", [], "any", false, false, false, 760);
        echo "`;
...
\t\t\t\t\tformData['ids'] = ['";
        // line 793
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 793, $this->source); })()), "id", [], "any", false, false, false, 793), "html", null, true);
        echo "'];
...
\t\t\t\t\tformData['ids'] = [\"";
        // line 879
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 879, $this->source); })()), "id", [], "any", false, false, false, 879), "html", null, true);
        echo "\"];
...
\t\t\t\t\t\t\t\t\tdata['ids'] = [\"";
        // line 939
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 939, $this->source); })()), "id", [], "any", false, false, false, 939), "html", null, true);
        echo "\"];
...
\t\t\t\t\tformData['ids'] = ['";
        // line 1011
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 1011, $this->source); })()), "id", [], "any", false, false, false, 1011), "html", null, true);
        echo "'];
\t\t\t\t\tformData['actionType'] = 'contentUpdate';
...
\t\t\t\t\t\t\t\t\t\tif(item.id != ";
        // line 1122
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 1122, $this->source); })()), "id", [], "any", false, false, false, 1122), "html", null, true);
        echo ")
\t\t\t\t\t\t\t\t\t\t\tparent.find('.uv-dropdown-list ul').append(\"<li data-id='\" + item.id + \"'>\" + item.name + \"</li>\")
\t\t\t\t\t\t\t\t\t});
\t\t\t\t\t\t\t\t}
...
{% endblock %}", "@UVDeskSupportCenter/Staff/Articles/articleForm.html.twig", "/home/lexcorp.xyz/public_html/uvdesk/vendor/uvdesk/support-center-bundle/Resources/views/Staff/Articles/articleForm.html.twig");
    }
}
