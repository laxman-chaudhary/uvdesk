...
class __TwigTemplate_baf275728b40c0a1c6049a000741abcf7cc6702cdf5dc7be542a642d4e8daee3 extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        // line 41
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Low"), "html", null, true);
        echo "
\t<% } else if (name == \"Medium\") { %>
\t\t";
        // line 43
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Medium"), "html", null, true);
        echo "
\t<%} else if (name == \"High\") { %>
\t\t";
        // line 45
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("High"), "html", null, true);
        echo "
\t<% } else if (name == \"Urgent\") { %>
\t\t";
        // line 47
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Urgent"), "html", null, true);
        echo "
\t<% } else if (name == \"Open\") { %>
\t\t";
        // line 49
...
\tsB.JsonActions = JSON.parse(\"";
        // line 85
        echo twig_escape_filter($this->env, twig_escape_filter($this->env, json_encode(twig_get_attribute($this->env, $this->source, (isset($context["uvdesk_automations"]) || array_key_exists("uvdesk_automations", $context) ? $context["uvdesk_automations"] : (function () { throw new RuntimeError('Variable "uvdesk_automations" does not exist.', 85, $this->source); })()), "getWorkflowActions", [0 => (((array_key_exists("forcedActions", $context) && (isset($context["forcedActions"]) || array_key_exists("forcedActions", $context) ? $context["forcedActions"] : (function () { throw new RuntimeError('Variable "forcedActions" does not exist.', 85, $this->source); })()))) ? (true) : (false))], "method", false, false, false, 85)), "js"), "html", null, true);
        echo "\");
...
\t\t\t";
        // line 191
        if (((isset($context["formData"]) || array_key_exists("formData", $context) ? $context["formData"] : (function () { throw new RuntimeError('Variable "formData" does not exist.', 191, $this->source); })()) && twig_get_attribute($this->env, $this->source, (isset($context["formData"]) || array_key_exists("formData", $context) ? $context["formData"] : (function () { throw new RuntimeError('Variable "formData" does not exist.', 191, $this->source); })()), "actions", [], "any", false, false, false, 191))) {
            // line 192
            echo "\t\t\t\tthis.createActions(\$.parseJSON(\"";
            echo twig_escape_filter($this->env, twig_escape_filter($this->env, json_encode(twig_get_attribute($this->env, $this->source, (isset($context["formData"]) || array_key_exists("formData", $context) ? $context["formData"] : (function () { throw new RuntimeError('Variable "formData" does not exist.', 192, $this->source); })()), "actions", [], "any", false, false, false, 192)), "js"), "html", null, true);
            echo "\"));
\t\t\t";
        } else {
            // line 194
...
\t\t\t";
        // line 197
        if ((array_key_exists("forcedActions", $context) && (isset($context["forcedActions"]) || array_key_exists("forcedActions", $context) ? $context["forcedActions"] : (function () { throw new RuntimeError('Variable "forcedActions" does not exist.', 197, $this->source); })()))) {
            // line 198
            echo "\t\t\t\tdIteration = 0;
...
\tsB.actionselectView = new sB.ActionSelectViews();
    ...
    {
        return array (  317 => 210,  303 => 198,  301 => 197,  298 => 196,  294 => 194,  288 => 192,  286 => 191,  213 => 121,  176 => 87,  171 => 85,  140 => 57,  135 => 55,  130 => 53,  125 => 51,  120 => 49,  115 => 47,  110 => 45,  105 => 43,  100 => 41,  91 => 35,  84 => 31,  74 => 24,  66 => 19,  47 => 3,  43 => 1,);
    }
...
\tsB.actionCollection = new sB.ActionCollection();
\tsB.actionselectView = new sB.ActionSelectViews();
</script>", "@UVDeskAutomation/Workflow/actions.html.twig", "/home/lexcorp.xyz/public_html/uvdesk/vendor/uvdesk/automation-bundle/Resources/views/Workflow/actions.html.twig");
    }
}
