...
class __TwigTemplate_605f8ba7b2131cf8ce79003c267f738610357c4f5a24b67049c961680621dd9d extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 52
        if ((0 === twig_compare(null, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 52, $this->source); })()), "request", [], "any", false, false, false, 52), "cookies", [], "any", false, false, false, 52), "get", [0 => "uv-sidebar-status"], "method", false, false, false, 52)))) {
            // line 53
...
\t</ul>
</div>", "@UVDeskCoreFramework/Templates/sidebar.html.twig", "/home/lexcorp.xyz/public_html/uvdesk/vendor/uvdesk/core-framework/Resources/views/Templates/sidebar.html.twig");
    }
}
