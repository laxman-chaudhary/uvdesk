...
class __TwigTemplate_e6607c50d9ae4d5032a03e09a7df120b2f00a6736b274bca3144c58497d3cabd extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"uv-aside\" {% if app.request.cookies and app.request.cookies.get('uv-asideView') %}style=\"display: none;\"{% endif %}>
    ...
    {% endif %}
</div>", "@UVDeskSupportCenter/Templates/solutionLeftSidebar.html.twig", "/home/lexcorp.xyz/public_html/uvdesk/vendor/uvdesk/support-center-bundle/Resources/views/Templates/solutionLeftSidebar.html.twig");
    }
}
