...
class __TwigTemplate_fcdfd19a882a2c9140ad1ba85985234b5f2dca40c5502badde09fef39b0ba573 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        // line 16
        if ((array_key_exists("categories", $context) &&  !twig_test_empty((isset($context["categories"]) || array_key_exists("categories", $context) ? $context["categories"] : (function () { throw new RuntimeError('Variable "categories" does not exist.', 16, $this->source); })())))) {
            // line 17
            echo "\t\t\t\t\t<ul>
\t\t\t\t\t\t";
            // line 18
...
\t{{parent()}}
{% endblock %}
", "@UVDeskSupportCenter/Knowledgebase/categoryListing.html.twig", "/home/lexcorp.xyz/public_html/uvdesk/vendor/uvdesk/support-center-bundle/Resources/views/Knowledgebase/categoryListing.html.twig");
    }
}
