...
class __TwigTemplate_ff638c371fee79616b524324e507b378df24f2c6efa9bca152999b4c036361f7 extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        ...
        // line 90
        echo (((twig_get_attribute($this->env, $this->source, ($context["formData"] ?? null), "status", [], "any", true, true, false, 90) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["formData"]) || array_key_exists("formData", $context) ? $context["formData"] : (function () { throw new RuntimeError('Variable "formData" does not exist.', 90, $this->source); })()), "status", [], "any", false, false, false, 90), "on")))) ? ("checked") : (""));
        echo ">
...
{% endblock %}
", "@UVDeskAutomation/Workflow/createWorkflow.html.twig", "/home/lexcorp.xyz/public_html/uvdesk/vendor/uvdesk/automation-bundle/Resources/views/Workflow/createWorkflow.html.twig");
    }
}
