...
class __TwigTemplate_46c6c0994e0427d0b2b7fb644a6ec733d106a324a390ec34697d88b39ffcab39 extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        ...
        // line 81
        echo (((twig_get_attribute($this->env, $this->source, ($context["formData"] ?? null), "status", [], "any", true, true, false, 81) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["formData"]) || array_key_exists("formData", $context) ? $context["formData"] : (function () { throw new RuntimeError('Variable "formData" does not exist.', 81, $this->source); })()), "status", [], "any", false, false, false, 81), "on")))) ? ("checked") : (""));
        echo ">
...
\t\t\t";
        // line 241
        if ( !(array_key_exists("forcedActions", $context) && (isset($context["forcedActions"]) || array_key_exists("forcedActions", $context) ? $context["forcedActions"] : (function () { throw new RuntimeError('Variable "forcedActions" does not exist.', 241, $this->source); })()))) {
            // line 242
...
{% endblock %}", "@UVDeskAutomation/PreparedResponse/createPreparedResponse.html.twig", "/home/lexcorp.xyz/public_html/uvdesk/vendor/uvdesk/automation-bundle/Resources/views/PreparedResponse/createPreparedResponse.html.twig");
    }
}
