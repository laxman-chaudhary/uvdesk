...
class __TwigTemplate_673670afa734c97227ae00af962b0d3f47840e4ed10ca065b3a82eaea64cc64a extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\tmsg: \"";
        // line 91
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("This field contain maximum 100 characters."), "html", null, true);
        echo "\"
\t\t\t\t\t}],
\t\t\t\t\t'description': [{
\t\t\t\t\t\trequired: true,
...
\t\t\t\t\t\tmsg: \"";
        // line 99
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("This field contain maximum 200 characters."), "html", null, true);
        echo "\"
\t\t\t\t\t}
\t\t\t\t\t],
\t\t\t\t}
...
\t\t\t\t\tvar jsonContext = JSON.parse('";
        // line 112
        echo (isset($context["errors"]) || array_key_exists("errors", $context) ? $context["errors"] : (function () { throw new RuntimeError('Variable "errors" does not exist.', 112, $this->source); })());
        echo "');
...
";
    ...
    {
        return array (  301 => 112,  285 => 99,  278 => 95,  271 => 91,  264 => 87,  257 => 83,  245 => 75,  235 => 74,  218 => 66,  208 => 59,  202 => 56,  195 => 52,  186 => 46,  181 => 44,  176 => 42,  167 => 36,  162 => 34,  157 => 32,  147 => 29,  142 => 26,  136 => 24,  130 => 22,  128 => 21,  121 => 19,  116 => 17,  113 => 16,  110 => 15,  107 => 14,  104 => 12,  94 => 11,  80 => 7,  74 => 5,  72 => 4,  60 => 3,  37 => 1,);
    }
...
\t\t});
\t</script>
{% endblock %}", "@UVDeskCoreFramework/ticketTypeAdd.html.twig", "/home/lexcorp.xyz/public_html/uvdesk/vendor/uvdesk/core-framework/Resources/views/ticketTypeAdd.html.twig");
    }
}
