...
class __TwigTemplate_3cc49748a0498e1681860a575994e7594252ce9dd085fcd4938832c46d821979 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<input type=\"hidden\" name=\"tempUsers\" class=\"uv-field\" value=\"\" />
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["agent"]) {
            ...
            echo "\">
                                        ";
            // line 49
            if ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, $context["agent"], "smallThumbnail", [], "any", false, false, false, 49), null))) {
                // line 50
                echo "                                            <img src=\"";
                echo twig_escape_filter($this->env, ((((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 50, $this->source); })()), "request", [], "any", false, false, false, 50), "scheme", [], "any", false, false, false, 50) . "://") . twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 50, $this->source); })()), "request", [], "any", false, false, false, 50), "httpHost", [], "any", false, false, false, 50)) . $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("")) . twig_get_attribute($this->env, $this->source, $context["agent"], "smallThumbnail", [], "any", false, false, false, 50)), "html", null, true);
                echo "\"/>
                                        ";
            } else {
                // line 52
...
\t\t});
\t</script>
{% endblock %}", "@UVDeskCoreFramework/Teams/updateSupportTeam.html.twig", "/home/lexcorp.xyz/public_html/uvdesk/vendor/uvdesk/core-framework/Resources/views/Teams/updateSupportTeam.html.twig");
    }
}
