...
class __TwigTemplate_65b5c7a7a21231c40d092d25460e29a289192acbd8fb23ca350b15b91b4be997 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\tvar jsonContext = JSON.parse('";
        // line 200
        echo (isset($context["errors"]) || array_key_exists("errors", $context) ? $context["errors"] : (function () { throw new RuntimeError('Variable "errors" does not exist.', 200, $this->source); })());
        echo "');
...
\t\t});
\t</script>
{% endblock %}", "@UVDeskCoreFramework/savedReplyForm.html.twig", "/home/lexcorp.xyz/public_html/uvdesk/vendor/uvdesk/core-framework/Resources/views/savedReplyForm.html.twig");
    }
}
