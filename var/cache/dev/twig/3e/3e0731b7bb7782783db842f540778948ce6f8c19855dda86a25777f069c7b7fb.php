...
class __TwigTemplate_db001552466e1f1a7ba7a3a7dab62ae629614b7e6d5203f2d31d4725f00037a5 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t";
        // line 64
        if ((array_key_exists("articlesEnabled", $context) && (0 === twig_compare((isset($context["articlesEnabled"]) || array_key_exists("articlesEnabled", $context) ? $context["articlesEnabled"] : (function () { throw new RuntimeError('Variable "articlesEnabled" does not exist.', 64, $this->source); })()), true)))) {
            // line 65
            echo "\t\t\t\t\t\t\t\t<th>";
...
\t\t";
        // line 124
        if ((array_key_exists("articlesEnabled", $context) && (0 === twig_compare((isset($context["articlesEnabled"]) || array_key_exists("articlesEnabled", $context) ? $context["articlesEnabled"] : (function () { throw new RuntimeError('Variable "articlesEnabled" does not exist.', 124, $this->source); })()), true)))) {
            // line 125
            echo "\t\t\t<td data-value=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Name"), "html", null, true);
            echo "\">
...
\t</script>
{% endblock %}
", "@UVDeskCoreFramework/supportTagList.html.twig", "/home/lexcorp.xyz/public_html/uvdesk/vendor/uvdesk/core-framework/Resources/views/supportTagList.html.twig");
    }
}
