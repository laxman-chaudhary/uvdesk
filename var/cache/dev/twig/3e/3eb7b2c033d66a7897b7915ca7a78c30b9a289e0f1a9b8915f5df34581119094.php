...
class __TwigTemplate_3ba507a5d196417317ecb71212cfba2d06b2ada60bde83fbc84b634a65509a15 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<option value=\"popularity\" ";
        // line 101
        echo (((twig_get_attribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 101, $this->source); })()), "sorting", [], "any", false, false, false, 101) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 101, $this->source); })()), "sorting", [], "any", false, false, false, 101), "popularity")))) ? ("selected") : (""));
        echo ">";
...
\t\t\t\t\t\tmsg: \"";
        // line 143
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("This field contain maximum 50 characters."), "html", null, true);
        echo "\"
\t\t\t\t\t}],
\t\t\t\t\t'description': [{
\t\t\t\t\t\trequired: true,
...
\t\t\t\t\t\tmsg: \"";
        // line 153
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("This field contain maximum 60 characters."), "html", null, true);
        echo "\"
\t\t\t\t\t}],
                    'sortOrder': {
                        pattern: '^[0-9]*\$',
...
\t\t\t\t\tvar jsonContext = JSON.parse('";
        // line 173
        echo (isset($context["errors"]) || array_key_exists("errors", $context) ? $context["errors"] : (function () { throw new RuntimeError('Variable "errors" does not exist.', 173, $this->source); })());
        echo "');
...
\t\t});
\t</script>
{% endblock %}", "@UVDeskSupportCenter/Staff/Category/categoryForm.html.twig", "/home/lexcorp.xyz/public_html/uvdesk/vendor/uvdesk/support-center-bundle/Resources/views/Staff/Category/categoryForm.html.twig");
    }
}
