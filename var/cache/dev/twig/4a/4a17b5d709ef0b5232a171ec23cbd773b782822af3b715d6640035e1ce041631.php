...
class __TwigTemplate_51d225a083759b8449ec0bc83755887813b67746a8637ab5e1237894378f8bad extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t";
        // line 109
        echo twig_escape_filter($this->env, (((0 === twig_compare(twig_get_attribute($this->env, $this->source, (isset($context["solution"]) || array_key_exists("solution", $context) ? $context["solution"] : (function () { throw new RuntimeError('Variable "solution" does not exist.', 109, $this->source); })()), "visibility", [], "any", false, false, false, 109), "public"))) ? ($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Published")) : ($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Draft"))), "html", null, true);
        echo "
\t\t\t\t\t\t\t</span>
...
\t\t});
\t</script>
{% endblock %}", "@UVDeskSupportCenter/Staff/Category/categoryListBySolution.html.twig", "/home/lexcorp.xyz/public_html/uvdesk/vendor/uvdesk/support-center-bundle/Resources/views/Staff/Category/categoryListBySolution.html.twig");
    }
}
